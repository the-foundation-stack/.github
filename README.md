...
Open by default. Apache 2.0 or equivalent. No "open core" with paid extensions.
Vendor-neutral. Specs don't presume Stripe, PayPal, AWS, or any single provider.
Self-hostable. No mandatory central registry, hub, or gateway.
Religiously informed where it matters, religiously neutral on the surface. We model Zakat properly because it has technical requirements (the 8 Asnaf, hawl, nisab, purification rules); we don't proselytise.
Practical over performative. Working code, real adopters, concrete examples. Less manifesto, more YAML.

Code of conduct
All projects under The Foundation adhere to the Contributor Covenant v2.1, with one explicit additional norm: no proselytising, in any direction. Keep the work technical; keep the spirit welcoming.
